...
function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 right-0 left-0 z-40 h-16 border-b border-slate-200 bg-white lg:pl-30">
        <div className="flex h-full items-center gap-3 px-4 md:pl-6 lg:px-6">
          ...
          >
            <BrandIcon size={16} boxClassName="h-8 w-8 shrink-0 rounded-lg lg:hidden" />
          ...
          <button
            type="button"
            className="ml-auto inline-flex rounded-lg p-2 text-slate-600 hover:bg-slate-100 lg:hidden"
            aria-label="Mở menu"
